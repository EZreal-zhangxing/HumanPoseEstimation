...
目前人体动作捕捉技术比较优秀的**实时的**算法主要是基于传统方法，例如DynamicFusion、DoubleFusion、BodyFusion等。基于神经网络的有NeuralTracking和OcclusionFusion等，包含追踪的内容少之又少。

Update:2026年04月21日15:07:01

*传统方法主要路线：是通过运动学求解器对连续帧中skeleton关键点的运动进行一个估计和优化。好处是快，缺点是求解的精度与数学模型高度相关以及误差累积的问题*

*神经网络的路线则是：通过网络回归出SMPL的参数，然后送入后处理（去抖动等）*
