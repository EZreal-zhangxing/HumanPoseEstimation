...
![image-20220411110008846](\image-20220411110008846.png)
...
![image-20220411112147670](\image-20220411112147670.png)
...
![image-20220411111225770](\image-20220411111225770.png)实验结果表明：足部关键点检测隐含地帮助网络更准确地预测一些身体关键点，尤其是腿部关键点，如脚踝位置

![image-20220411111540470](\image-20220411111540470.png)

只有身体的数据集，网络并不能很好的预测脚踝。而包含脚踝的数据集可以。

### Experiment

![image-20220411115202787](\image-20220411115202787.png)
...
![image-20220411115638165](\image-20220411115638165.png)
